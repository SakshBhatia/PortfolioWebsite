...
async function getHardResponse(userText) {
    const apiKey = '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';
...
// Update this function to take message input and reply with the help of OpenAI API
